    ...
    data: [
      {
        ...
        type: 'scatter',
        mode: 'lines+markers',
        name: 'E[kappa] without normalization',
        marker: { color: '#0E7490' },
        line: { width: 3 }
      },
      {
        ...
        type: 'scatter',
        mode: 'lines+markers',
        name: 'E[kappa] with normalization',
        marker: { color: '#B45309' },
        line: { width: 3 }
      }
    ],
    layout: {
      title: { text: 'Transport Gate vs Pre-Activation Scale' },
  ...
  spec={{
    data: [
      ...
      },
      {
        ...
        type: 'bar',
        name: 'Value variance (lower is stabler)',
        marker: { color: '#B45309' },
        yaxis: 'y2'
      }
    ],
    layout: {
      title: { text: 'Toy Ablation: Policy Motion vs Stability' },
      barmode: 'group',
