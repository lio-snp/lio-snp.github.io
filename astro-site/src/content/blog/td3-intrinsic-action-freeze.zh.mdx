...
<img src={figTransport.src} alt="门控传输 vs 预激活尺度" />

*图：预激活尺度升高时，门控传输在未归一化情形下明显下降。*

### 5.3 Ablation：哪些改动真正让动作动起来

<img src={figAblation.src} alt="Toy Ablation: 动作变化与稳定性的平衡" />

*图：不同 ablation 设置下的动作变化幅度与 value 方差对比。*
